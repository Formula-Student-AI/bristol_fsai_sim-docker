        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'map_path' field must be a set or sequence and each value of type 'str'"
...
class Metaclass_GetMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from eufs_msgs.srv import _get_map
...
class GetMap(metaclass=Metaclass_GetMap):
    from eufs_msgs.srv._get_map import GetMap_Request as Request
    from eufs_msgs.srv._get_map import GetMap_Response as Response
