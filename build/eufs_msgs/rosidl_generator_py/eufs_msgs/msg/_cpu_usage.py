...
class Metaclass_CpuUsage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from eufs_msgs.msg import CpuStatus
...
class CpuUsage(metaclass=Metaclass_CpuUsage):
    ...
    _fields_and_field_types = {
        ...
        'all': 'eufs_msgs/CpuStatus',
        'cpus': 'sequence<eufs_msgs/CpuStatus>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['builtin_interfaces', 'msg'], 'Time'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['eufs_msgs', 'msg'], 'CpuStatus'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['eufs_msgs', 'msg'], 'CpuStatus')),  # noqa: E501
    )
