...
#include "eufs_msgs/msg/detail/cpu_status__rosidl_typesupport_fastrtps_c.h"
...
using _CpuStatus__ros_msg_type = eufs_msgs__msg__CpuStatus;
...
static uint32_t _CpuStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_eufs_msgs__msg__CpuStatus(
...
{
  return max_serialized_size_eufs_msgs__msg__CpuStatus(
    full_bounded, 0);
}
