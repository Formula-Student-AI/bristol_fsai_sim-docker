...
static size_t _RecordStart_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_eufs_msgs__srv__RecordStart_Request(
    full_bounded, 0);
}
...
static size_t _RecordStart_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_eufs_msgs__srv__RecordStart_Response(
    full_bounded, 0);
}
