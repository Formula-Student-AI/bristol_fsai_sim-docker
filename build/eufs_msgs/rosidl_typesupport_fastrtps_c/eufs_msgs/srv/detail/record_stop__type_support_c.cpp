...
static size_t _RecordStop_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_eufs_msgs__srv__RecordStop_Request(
    full_bounded, 0);
}
...
static size_t _RecordStop_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_eufs_msgs__srv__RecordStop_Response(
    full_bounded, 0);
}
