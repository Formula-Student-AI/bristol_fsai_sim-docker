...
{
  eufs_msgs__srv__RecordStart_Request * msg = (eufs_msgs__srv__RecordStart_Request *)malloc(sizeof(eufs_msgs__srv__RecordStart_Request));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__srv__RecordStart_Request__Sequence__init(eufs_msgs__srv__RecordStart_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__srv__RecordStart_Request *)calloc(size, sizeof(eufs_msgs__srv__RecordStart_Request));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__srv__RecordStart_Request__Sequence * array = (eufs_msgs__srv__RecordStart_Request__Sequence *)malloc(sizeof(eufs_msgs__srv__RecordStart_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  eufs_msgs__srv__RecordStart_Response * msg = (eufs_msgs__srv__RecordStart_Response *)malloc(sizeof(eufs_msgs__srv__RecordStart_Response));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__srv__RecordStart_Response__Sequence__init(eufs_msgs__srv__RecordStart_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__srv__RecordStart_Response *)calloc(size, sizeof(eufs_msgs__srv__RecordStart_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  eufs_msgs__srv__RecordStart_Response__Sequence * array = (eufs_msgs__srv__RecordStart_Response__Sequence *)malloc(sizeof(eufs_msgs__srv__RecordStart_Response__Sequence));
  if (!array) {
    return NULL;
  }
