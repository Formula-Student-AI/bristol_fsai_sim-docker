...
{
  eufs_msgs__msg__ConeWithCovariancePlus * msg = (eufs_msgs__msg__ConeWithCovariancePlus *)malloc(sizeof(eufs_msgs__msg__ConeWithCovariancePlus));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__ConeWithCovariancePlus__Sequence__init(eufs_msgs__msg__ConeWithCovariancePlus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__ConeWithCovariancePlus *)calloc(size, sizeof(eufs_msgs__msg__ConeWithCovariancePlus));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__ConeWithCovariancePlus__Sequence * array = (eufs_msgs__msg__ConeWithCovariancePlus__Sequence *)malloc(sizeof(eufs_msgs__msg__ConeWithCovariancePlus__Sequence));
  if (!array) {
    return NULL;
  }
