...
{
  eufs_msgs__msg__ConeArrayWithCovariancePlus * msg = (eufs_msgs__msg__ConeArrayWithCovariancePlus *)malloc(sizeof(eufs_msgs__msg__ConeArrayWithCovariancePlus));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__ConeArrayWithCovariancePlus__Sequence__init(eufs_msgs__msg__ConeArrayWithCovariancePlus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__ConeArrayWithCovariancePlus *)calloc(size, sizeof(eufs_msgs__msg__ConeArrayWithCovariancePlus));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__ConeArrayWithCovariancePlus__Sequence * array = (eufs_msgs__msg__ConeArrayWithCovariancePlus__Sequence *)malloc(sizeof(eufs_msgs__msg__ConeArrayWithCovariancePlus__Sequence));
  if (!array) {
    return NULL;
  }
