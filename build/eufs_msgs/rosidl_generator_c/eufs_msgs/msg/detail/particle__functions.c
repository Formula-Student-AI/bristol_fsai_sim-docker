...
{
  eufs_msgs__msg__Particle * msg = (eufs_msgs__msg__Particle *)malloc(sizeof(eufs_msgs__msg__Particle));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__Particle__Sequence__init(eufs_msgs__msg__Particle__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__Particle *)calloc(size, sizeof(eufs_msgs__msg__Particle));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__Particle__Sequence * array = (eufs_msgs__msg__Particle__Sequence *)malloc(sizeof(eufs_msgs__msg__Particle__Sequence));
  if (!array) {
    return NULL;
  }
