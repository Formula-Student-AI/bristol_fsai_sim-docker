...
{
  eufs_msgs__msg__ParticleStamped * msg = (eufs_msgs__msg__ParticleStamped *)malloc(sizeof(eufs_msgs__msg__ParticleStamped));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__ParticleStamped__Sequence__init(eufs_msgs__msg__ParticleStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__ParticleStamped *)calloc(size, sizeof(eufs_msgs__msg__ParticleStamped));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__ParticleStamped__Sequence * array = (eufs_msgs__msg__ParticleStamped__Sequence *)malloc(sizeof(eufs_msgs__msg__ParticleStamped__Sequence));
  if (!array) {
    return NULL;
  }
