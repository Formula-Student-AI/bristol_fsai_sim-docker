...
{
  eufs_msgs__msg__StereoImage * msg = (eufs_msgs__msg__StereoImage *)malloc(sizeof(eufs_msgs__msg__StereoImage));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__StereoImage__Sequence__init(eufs_msgs__msg__StereoImage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__StereoImage *)calloc(size, sizeof(eufs_msgs__msg__StereoImage));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__StereoImage__Sequence * array = (eufs_msgs__msg__StereoImage__Sequence *)malloc(sizeof(eufs_msgs__msg__StereoImage__Sequence));
  if (!array) {
    return NULL;
  }
