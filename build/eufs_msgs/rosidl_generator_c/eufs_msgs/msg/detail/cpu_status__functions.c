...
{
  eufs_msgs__msg__CpuStatus * msg = (eufs_msgs__msg__CpuStatus *)malloc(sizeof(eufs_msgs__msg__CpuStatus));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__CpuStatus__Sequence__init(eufs_msgs__msg__CpuStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__CpuStatus *)calloc(size, sizeof(eufs_msgs__msg__CpuStatus));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__CpuStatus__Sequence * array = (eufs_msgs__msg__CpuStatus__Sequence *)malloc(sizeof(eufs_msgs__msg__CpuStatus__Sequence));
  if (!array) {
    return NULL;
  }
