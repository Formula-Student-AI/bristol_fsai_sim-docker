...
{
  eufs_msgs__msg__ConeAssociation * msg = (eufs_msgs__msg__ConeAssociation *)malloc(sizeof(eufs_msgs__msg__ConeAssociation));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__ConeAssociation__Sequence__init(eufs_msgs__msg__ConeAssociation__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__ConeAssociation *)calloc(size, sizeof(eufs_msgs__msg__ConeAssociation));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__ConeAssociation__Sequence * array = (eufs_msgs__msg__ConeAssociation__Sequence *)malloc(sizeof(eufs_msgs__msg__ConeAssociation__Sequence));
  if (!array) {
    return NULL;
  }
