...
{
  eufs_msgs__msg__ConeAssociationArray * msg = (eufs_msgs__msg__ConeAssociationArray *)malloc(sizeof(eufs_msgs__msg__ConeAssociationArray));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__ConeAssociationArray__Sequence__init(eufs_msgs__msg__ConeAssociationArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__ConeAssociationArray *)calloc(size, sizeof(eufs_msgs__msg__ConeAssociationArray));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__ConeAssociationArray__Sequence * array = (eufs_msgs__msg__ConeAssociationArray__Sequence *)malloc(sizeof(eufs_msgs__msg__ConeAssociationArray__Sequence));
  if (!array) {
    return NULL;
  }
