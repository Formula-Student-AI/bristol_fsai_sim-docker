...
{
  eufs_msgs__msg__ParticleSLAMStamped * msg = (eufs_msgs__msg__ParticleSLAMStamped *)malloc(sizeof(eufs_msgs__msg__ParticleSLAMStamped));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__ParticleSLAMStamped__Sequence__init(eufs_msgs__msg__ParticleSLAMStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__ParticleSLAMStamped *)calloc(size, sizeof(eufs_msgs__msg__ParticleSLAMStamped));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__ParticleSLAMStamped__Sequence * array = (eufs_msgs__msg__ParticleSLAMStamped__Sequence *)malloc(sizeof(eufs_msgs__msg__ParticleSLAMStamped__Sequence));
  if (!array) {
    return NULL;
  }
