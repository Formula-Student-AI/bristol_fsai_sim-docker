...
{
  eufs_msgs__msg__CpuUsage * msg = (eufs_msgs__msg__CpuUsage *)malloc(sizeof(eufs_msgs__msg__CpuUsage));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__CpuUsage__Sequence__init(eufs_msgs__msg__CpuUsage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__CpuUsage *)calloc(size, sizeof(eufs_msgs__msg__CpuUsage));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__CpuUsage__Sequence * array = (eufs_msgs__msg__CpuUsage__Sequence *)malloc(sizeof(eufs_msgs__msg__CpuUsage__Sequence));
  if (!array) {
    return NULL;
  }
