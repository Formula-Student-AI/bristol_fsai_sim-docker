...
{
  eufs_msgs__msg__ConeAssociationArrayStamped * msg = (eufs_msgs__msg__ConeAssociationArrayStamped *)malloc(sizeof(eufs_msgs__msg__ConeAssociationArrayStamped));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__ConeAssociationArrayStamped__Sequence__init(eufs_msgs__msg__ConeAssociationArrayStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__ConeAssociationArrayStamped *)calloc(size, sizeof(eufs_msgs__msg__ConeAssociationArrayStamped));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__ConeAssociationArrayStamped__Sequence * array = (eufs_msgs__msg__ConeAssociationArrayStamped__Sequence *)malloc(sizeof(eufs_msgs__msg__ConeAssociationArrayStamped__Sequence));
  if (!array) {
    return NULL;
  }
